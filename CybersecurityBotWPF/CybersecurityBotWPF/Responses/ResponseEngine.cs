...
namespace CybersecurityBotWPF.Responses
{
    ...
    public class ResponseEngine
    {
        ...
        public ResponseEngine() => _topics = BuildTopics();
        ...
        public string GetResponse(string input, string userName, UserMemory memory)
        {
            ...
            foreach (var topic in _topics)
            {
                if (topic.Keywords.Any(k => lower.Contains(k)))
                {
                    ...
                    if (!string.IsNullOrEmpty(recall) && memory.FavouriteTopic != topic.TopicName)
                        response += $"\n\n💡 {recall}";
            ...
            return $"I'm not sure I understand that, {userName}. " +
                   "Try asking about passwords, phishing, malware, 2FA, encryption, " +
                   "VPNs, data breaches, or type 'help' for a full list!";
        }
        ...
        public string GetFollowUp(string topicName, string userName)
        {
            ...
            return topic == null
                ? $"I don't have extra details on '{topicName}' right now, {userName}. Try asking about a specific aspect!"
                : topic.FollowUp.Replace("{name}", userName);
        }
        ...
        private static List<TopicEntry> BuildTopics() => new()
        {
            ...
            new TopicEntry
            {
                ...
                FollowUp =
                    ...
                    "  • Dictionary attacks use common words, so avoid them entirely.\n" +
                    "  • NIST now recommends long passphrases over complex short passwords.\n" +
                    "  • Enable 'Have I Been Pwned' alerts to know if your password leaks."
            },
            ...
            new TopicEntry
            {
                ...
                Responses = new[]
                {
                    ...
                    "  • They alert you to duplicate or weak passwords.\n" +
                ...
                FollowUp =
                    ...
                    "  • If you lose your master password, most managers cannot recover it — choose carefully!"
            },
            ...
            new TopicEntry
            {
                ...
                Responses = new[]
                {
                    ...
                    "  • Sender email doesn't match the organisation.\n" +
                    ...
                    "Great awareness asking about phishing, {name}! Here's a key tip:\n\n" +
                    "  • Spear phishing targets YOU specifically using your real name and details.\n" +
                    "  • Check for subtle misspellings: 'Micros0ft', 'Paypa1', 'Amaz0n'.\n" +
                    "  • Phone call phishing is called 'vishing'.\n" +
                    "  • SMS phishing is 'smishing' — never click unexpected text links."
                },
                FollowUp =
                    "Digging deeper into phishing, {name}:\n\n" +
                    "  • 'Whaling' targets senior executives with highly convincing fake emails.\n" +
            ...
            new TopicEntry
            {
                ...
                Responses = new[]
                {
                    ...
                    "  • Real companies never ask for passwords or PINs over the phone.\n" +
                ...
                FollowUp =
                    ...
                    "  • If pressured for immediate payment, it is almost certainly a scam."
            },
            ...
            new TopicEntry
            {
                ...
                Responses = new[]
                {
                    ...
                    "  • Disable macros in Office documents unless specifically required.\n" +
                    "  • Use endpoint detection tools if running a business network."
                },
                FollowUp =
                    "Going deeper on ransomware, {name}:\n\n" +
                    "  • WannaCry (2017) infected 230,000+ computers across 150 countries in days.\n" +
                    "  • Ransomware-as-a-Service (RaaS) lets criminals rent attack tools cheaply.\n" +
                    "  • Average ransom demand exceeded $1 million for businesses in 2024.\n" +
                    "  • Always follow the 3-2-1 backup rule to recover without ever paying."
            },
            ...
            new TopicEntry
            {
                ...
                Responses = new[]
                {
                    ...
                    "  • Hardware keys (YubiKey) offer the strongest possible protection.",
                    ...
                    "  • If you lose your 2FA app, backup codes let you recover access.\n" +
                ...
                FollowUp =
                    ...
                    "  • FIDO2/WebAuthn allows phishing-resistant authentication.\n" +
            ...
            new TopicEntry
            {
                ...
                Responses = new[]
                {
                    ...
                    "  • Encrypted data stolen in a breach is useless without the decryption key.",

                    "Great question on encryption, {name}!\n\n" +
                    "  • AES-256 is the gold standard algorithm — used by governments worldwide.\n" +
            ...
            new TopicEntry
            {
                ...
                FollowUp =
                    "More on VPNs and Wi-Fi safety, {name}:\n\n" +
                    "  • A VPN routes traffic through an encrypted tunnel to a remote server.\n" +
                    "  • It hides your IP address and location from websites you visit.\n" +
            ...
            new TopicEntry
            {
                ...
                Responses = new[]
                {
                    ...
                    "  • Tailgating: following someone into a secure building without authorisation.\n" +
                    "  • Always verify identities before sharing ANY sensitive information.",

                    "Humans are often the weakest link — and attackers know it, {name}!\n\n" +
                    "  • Be sceptical of unexpected requests, even from apparent colleagues.\n" +
                    "  • Verify out-of-band — if IT calls asking for your password, call them back.\n" +
                    "  • Authority and urgency are social engineers' favourite pressure tools.\n" +
                ...
                FollowUp =
                    ...
                    "  • Kevin Mitnick, one of history's most famous hackers, relied almost entirely on it.\n" +
                    "  • 'Quid pro quo' attacks offer something in exchange for information or access.\n" +
                    "  • Physical security matters too — shred documents and don't let strangers tailgate."
            },
            ...
            new TopicEntry
            {
                ...
                Responses = new[]
                {
                    ...
                    "  • Check site reputation with Google Safe Browsing or VirusTotal."
                },
                FollowUp =
                    ...
                    "  • Private/Incognito mode hides history locally but NOT from your ISP.\n" +
                    "  • The EFF's 'Cover Your Tracks' shows how unique your browser fingerprint is."
            },
            ...
            new TopicEntry
            {
                ...
                FollowUp =
                    ...
                    "  • Versioned backups let you restore to a point before ransomware struck.\n" +
                    "  • Immutable backups cannot be altered or deleted — the gold standard.\n" +
                    "  • RPO and RTO are key metrics businesses use to define their backup strategy."
            },
            ...
            new TopicEntry
            {
                ...
                Responses = new[]
                {
                    ...
                    "  • Never share your ID number or banking details via email or phone.\n" +
                    ...
                    "  • Use credit monitoring services to be alerted of suspicious activity.",
                    ...
                    "  • Be careful what you share on social media — birthdate and city are valuable to fraudsters.\n" +
            ...
            new TopicEntry
            {
                ...
                Responses = new[]
                {
                    ...
                    "  • Unique passwords per site mean one breach doesn't cascade to others.",
                    ...
                    "  • Common breached data includes emails, passwords, phone numbers, and addresses.\n" +
                    "  • Hashed passwords can still be cracked if they're weak or common.\n" +
                    "  • Enable 2FA so a leaked password alone can't compromise your account."
                },
                FollowUp =
                    "More on data breaches, {name}:\n\n" +
                    "  • The 2013 Yahoo breach exposed 3 billion accounts — the largest ever recorded.\n" +
                    "  • GDPR in Europe requires companies to report breaches within 72 hours.\n" +
                    "  • POPIA in South Africa similarly requires breach notification to the regulator.\n" +
                    "  • Credential stuffing uses leaked combos to attack other sites automatically."
            },
            ...
            new TopicEntry
            {
                ...
                FollowUp =
                    ...
                    "  • The Tor network anonymises your traffic by routing through multiple relays.\n" +
            ...
            new TopicEntry
            {
                ...
                Responses = new[]
                {
                    "Cloud storage is convenient but needs careful security habits, {name}!\n\n" +
                    "  • Enable 2FA on every cloud account — Drive, OneDrive, Dropbox, iCloud.\n" +
                    "  • Don't store unencrypted sensitive files in the cloud.\n" +
                ...
                FollowUp =
                    ...
                    "  • Misconfigured public cloud storage (S3 buckets) causes many major breaches.\n" +
                    "  • Cryptomator encrypts files locally before they reach the cloud — great tool.\n" +
                    "  • Review sharing links — don't share folders publicly if only specific people need access.\n" +
                    "  • Cloud providers operate on a shared responsibility model for security."
            },
            ...
            new TopicEntry
            {
                ...
                Responses = new[]
                {
                    ...
                    "  • Maintain open, non-judgmental conversations about their online experiences."
                },
                FollowUp =
                    "More on children's online safety, {name}:\n\n" +
                    "  • Platforms like TikTok and Instagram have minimum age restrictions — enforce them.\n" +
                    "  • Online gaming can expose children to strangers — review friend and chat settings.\n" +
                    "  • Teach children that online friends are still strangers until proven otherwise.\n" +
                    "  • Report suspected online grooming to SAPS or the Cyber Crime Unit."
            },
            ...
            new TopicEntry
            {
                ...
                Responses = new[]
                {
                    "Keeping software updated is one of the easiest security wins, {name}!\n\n" +
                    "  • Most attacks exploit known vulnerabilities that already have patches available.\n" +
                    "  • Enable automatic updates for your OS, browser, and apps.\n" +
                    "  • Don't ignore update notifications — they are often security critical.\n" +
                    "  • Remove software you no longer use — unused apps still pose a risk."
                },
                FollowUp =
                    "More on patching and updates, {name}:\n\n" +
                    "  • Zero-day vulnerabilities have no patch yet — update quickly once one is released.\n" +
                    "  • Patch management tools help businesses keep hundreds of systems updated.\n" +
                    "  • End-of-life (EOL) software no longer receives patches — time to upgrade.\n" +
                    "  • The Equifax breach (2017) exposed 147 million people due to one unpatched flaw."
            },
            ...
            new TopicEntry
            {
                ...
                Responses = new[]
                {
                    ...
                    "  • They monitor and filter incoming and outgoing network traffic.\n" +
